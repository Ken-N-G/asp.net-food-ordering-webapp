<%@ Page Title="Add Product" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AdminAddProduct.aspx.cs" Inherits="MunchHub.WebForm21" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 d-flex flex-column">
                    ...
                    <div class="custom-inline-text d-flex justify-content-center">
                        <asp:Button ID="saveChanges" runat="server" CssClass="btn custom-btn-primary" Text="Add Product" OnClick="saveChanges_Click"/>
                    </div>
                </div>
            </div>
        </div>
